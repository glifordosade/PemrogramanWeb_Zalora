<div class="putih">
    <div class="main">
        <div class="topList">
            <a href=""><img class="bulatan" src="<?= BASEURL;?>/img/ssatu.png" alt="gambar"></a>
            <a href=""><img class="bulatan" src="<?= BASEURL;?>/img/sdua.png" alt="gambar"></a>
            <a href=""><img class="bulatan" src="<?= BASEURL;?>/img/stiga.png" alt="gambar"></a>
            <a href=""><img class="bulatan" src="<?= BASEURL;?>/img/sempat.png" alt="gambar"></a>
            <a href=""><img class="bulatan" src="<?= BASEURL;?>/img/slima.png" alt="gambar"></a>
            <a href=""><img class="bulatan" src="<?= BASEURL;?>/img/senam.png" alt="gambar"></a>
